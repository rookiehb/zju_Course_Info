...
/* INSERT YOUR CODE FROM HERE */  
  else if(funct7 == 2)
    {
      ...
      if (funct3 == 5) return instTable_.getEntry(InstId::MAJ);
		...
		if (funct3 == 0) return instTable_.getEntry(InstId::EP0);
      		if (funct3 == 1) return instTable_.getEntry(InstId::EP1);
      		if (funct3 == 2) return instTable_.getEntry(InstId::SIG0);
      		if (funct3 == 3) return instTable_.getEntry(InstId::SIG1);
