...
gs_menu_color = {
	"Dark gray",      "Dark gray",	"Red",	    "Red",   0 , // 不填充 //王涵到此一游  
},

gs_button_color = {
	"Moccasin",      "Black",	"Moccasin",	    "Red",   1 , // 不填充
},
...
void change_color()
{
	if (style_choice == 1)
		{
		strcpy(gs_menu_color.frame,"SpringGreen3");
		strcpy(gs_menu_color.label,"SpringGreen3");
		}
	else if (style_choice==2)
		{
		strcpy(gs_menu_color.frame,"Dark gray");
		strcpy(gs_menu_color.label,"Dark gray");
		}
	else if (style_choice==3)
		{
		strcpy(gs_menu_color.frame,"HotPink");
		strcpy(gs_menu_color.label,"HotPink");
		}
}
